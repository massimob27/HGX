...
HGX implements a hierarchical parent-child organization of predicates that enables structural pruning of irrelevant branches, and guarantees schema-constrained LLM outputs based on the type specifications under each predicate in an application file. HGX is capable of reading both flat and hierarchical yaml application files.
